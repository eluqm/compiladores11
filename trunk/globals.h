...
typedef enum { INTEGER,INCREMENT,ERROR,ENDFILE, CLASS, REGION, ID, IN, THIS, NEW, READS, WRITES, DOUBLE, VOID, LET,
                NUM, SEQ, COBEGIN, PUNTOYCOMA, COMA, LLAVE_A, LLAVE_C, PAR_A, PAR_C,
                IGUAL, PUNTO, COR_A, COR_C, DOLARFIN, ACCEPT,POWE,
	NUMERAL,ASTERISCO,POINT,IGUAL2,IF,REAL,STRING,WHILE,ELSE,RETURN,
	DOSPUNTOS,
	LESS,
	GREATER,
	CONCATENAR,
	MAS,
	MOD,COMMENT,CADENA,C,D}Token_t;
